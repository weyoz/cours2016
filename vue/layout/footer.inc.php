...
<div class="helloc"></div>
				<form id="formu" action="?module=user&amp;action=login" method="post">
					<p>
						<input id="pseudo" name="pseudo" type="text" class="connex" placeholder="Pseudo">
						<input id="password" name="password" type="password" class="connex" placeholder="password"></br>
...
<script type="text/javascript" src="assets/js/verif_delete.js"></script>
